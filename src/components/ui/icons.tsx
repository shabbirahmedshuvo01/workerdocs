...
export function IconUpload({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconShieldCheck({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconXCircle({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSpinner({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
